...
def main():
    ...
    #better_draw_circles(rg.Point(6,3) , 10)
    #better_draw_circles(rg.Point(100,-100), 20)
    #even_better_draw_circles(rg.Point(200,-200), 40, 8, 'blue', 10)
    even_better_draw_circles(rg.Point(100, 100), 20, 8, 'blue', 10)
    even_better_draw_circles(rg.Point(-100, -100), 20, 8, 'blue', 10)
    even_better_draw_circles(rg.Point(0, 50), 70, 8, 'blue', 10)
...
def better_draw_circles(point, radial_increase):
    """
    ...
    for k in range(1, 11):  # k becomes 1, 2, 3, ... 10
        ...
        # Go DOWN 15 pixels, ending up pointing east again
        turtle.right(90)
        turtle.forward(radial_increase)
        turtle.left(90)

        turtle.pen_down()
        turtle.draw_circle(radial_increase * k)  # Radius 15, 30, 45, 60, ...
...
def even_better_draw_circles(point, radial_increase, thickness1, color1, ncircle):
    turtle = rg.SimpleTurtle()
    turtle.speed = 100
    turtle.pen_up()
    turtle.go_to(point)
    turtle.set_heading(0)  # Point "east" (towards the right)
    turtle.pen = rg.Pen(color1, thickness1)

    for ncircle in range(1, 11):  # k becomes 1, 2, 3, ... 10
        ...
        turtle.pen_down()
        turtle.draw_circle(radial_increase * ncircle)  # Radius 15, 30, 45, 60, ...
