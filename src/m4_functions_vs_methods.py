...
def try_functions():
    ...
    ###########################################################################
popeye = rg.SimpleTurtle()
jump_and_move_turtle(200, 100, 300, 30)

swi = rg.SimpleTurtle()
jump_and_move_turtle(100, 200, 0, 0)

wolfy = rg.SimpleTurtle()
...
mike.pen = rg.Pen('blue', 5)
mike.backward(150)
mike.speed = 1
draw_many_squares(mike, 2, 100, 30)
mike.speed = 5
mike.pen = rg.Pen('red', 2)
draw_many_squares(mike, 10, 50, 15)
mike.speed = 100
mike.pen = rg.Pen('green', 35)
draw_many_squares(mike, 8, 300, 60)
